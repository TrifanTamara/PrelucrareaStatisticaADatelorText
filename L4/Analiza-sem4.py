...
nuclee=baza['Numar nuclee']
rating=baza['Rating']
procesor=baza['Tip procesor']
frecv=baza['Frecventa nominala']
procgr=baza['Procesor grafic integrat']


print (newprice.describe())
print (nuclee.describe())
print (rating.describe())
print (procesor.describe())
print (frecv.describe())
print (procgr.describe())
...
print(baza.nuclee.hist(bins=(5), color='purple',grid='False'))
plt.xlabel( 'Nuclee')
...
print(baza.procgr.value_counts())
print(baza.procgr.value_counts()/1079)
